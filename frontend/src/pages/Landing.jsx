      ...
      <section className="py-20 bg-white">
        <div className="container mx-auto px-4">
          <div className="flex flex-col md:flex-row items-center gap-10 max-w-5xl mx-auto">
            ...
            {/* =================== */}
            {/* ============================== */}
{/* Happy Donors Section - Tailwind Animated */}
  ...
  <div className="container mx-auto px-4">
    <div className="max-w-3xl mx-auto text-center mb-14">
      ...
      <p className="text-slate-600 text-lg">
        Real heroes who step forward to save lives every single day.
      </p>
    </div>
            ...
            {[
              {
                ...
                quote: "Donating blood is my way of giving back!",
              },
              {
                name: "Michael Chen",
                blood: "A-",
                img: "https://randomuser.me/api/portraits/men/45.jpg",
                quote: "Knowing my blood can save lives keeps me coming back.",
              },
              {
                name: "Priya Patel",
                blood: "B+",
                img: "https://randomuser.me/api/portraits/women/68.jpg",
                quote: "The staff makes donating a pleasant experience.",
              },
              {
                name: "David Wilson",
                blood: "AB+",
                img: "https://randomuser.me/api/portraits/men/22.jpg",
                quote: "15 donations and counting!",
              },
              {
                name: "Emma Garcia",
                blood: "O-",
                img: "https://randomuser.me/api/portraits/women/53.jpg",
                quote: "Universal donor, universal responsibility.",
              },
            ].map((donor, index) => (
              <div
                key={index}
                className="min-w-[280px] bg-slate-50 rounded-2xl shadow-lg p-6 text-center border border-slate-100 hover:shadow-xl transition-all duration-300"
              >
                <img
                  src={donor.img}
                  alt={donor.name}
                  className="w-20 h-20 mx-auto rounded-full mb-4 border-4 border-red-100"
                />
